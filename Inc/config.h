...
#define PH_CURRENT_MAX 600			//iq value (phase current in rotating frame), not calibrated yet
...
#define OFFSET_A 1880//952 				//Offset of current sensing phase A
#define OFFSET_B 1883//957				//Offset of current sensing phase B
#define OFFSET_C 1870//981				//Offset of current sensing phase C
